...
from dataset_modify import RecWithContrastiveLearningDataset

from trainer_modify import ICLRecTrainer
from model_modify import SASRecModel, OfflineItemSimilarity, OnlineItemSimilarity
from src.utils import EarlyStopping, get_user_seqs, get_item2attribute_json, check_path, set_seed
...
def main():
    ...
    parser.add_argument("--res", type=float, default=0.3, help="reorder ratio for reorder operator")
    ...
    user_seq, max_item, valid_rating_matrix, test_rating_matrix, num_user, num_item = get_user_seqs(args.data_file)
    ...
    args.log_file = os.path.join(args.output_dir, args_str + "attffn+da.txt")
